"""pfx agent — production implementation.

Patient Financial Experience: propensity-to-pay scoring and payment plan optimization at point of discharge. HITL-governed.
